...
const  randomlocation=goeLocation[Math.floor(Math.random()*location.length)]
...
console.log( `You will be a ${randomJob} in ${randomlocation} and married to ${randomPartnerName} with ${randomNumOfKids} kids`)
}
